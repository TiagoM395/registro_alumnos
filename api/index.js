...
/**
 * index.js - Servidor backend API para gestión de estudiantes, carreras y categorías
 * 
 * Este archivo implementa un servidor Express con endpoints RESTful para:
 * - CRUD de estudiantes
 * - CRUD de carreras
 * - CRUD de categorías de carreras
 * 
 * Los datos se persisten en archivos JSON y se protegen con autenticación por API Key.
 */
...
// Verifica si los archivos existen, si no, los crea con un array vacío
...
//// (Funciones similares loadCareers/saveCareers y loadCategories/saveCategories omitidas por brevedad)

// Función para leer carreras desde archivo json
...
// Función para guardar carreras en archivo json
...
// Función para leer categorías desde archivo json
...
// Función para guardar categorías en archivo json
...
// Middleware para validar API Key en todas las rutas
...
//la api espera un posteo,la graba
app.post('/api/students', (req, res) => {
    ...
    //lo empuja adentro de la array de estudiantes
...
// ============================
/*
1. El servidor Express expone endpoints RESTful para estudiantes, carreras y categorías.
2. Cada recurso se almacena en un archivo JSON y se carga en memoria al iniciar.
3. Todas las rutas están protegidas por API Key.
4. Los endpoints permiten registrar, consultar y eliminar recursos.
5. Los cambios se guardan en los archivos correspondientes.
*/